...
WHERE S.State = 2 AND (NOT S.IsMedia OR S.MediaExtension IN ('swf', 'dcr', 'wrl', 'wrz', 'mid', 'mod', 's3m', 'xm', 'aif', 'aiff', 'au', 'avi', 'flac', 'flv', 'mkv', 'mov', 'mp3', 'mp4', 'mpeg', 'mpg', 'ogg', 'ra', 'ram', 'rm', 'wav', 'webm', 'wma', 'wmv'))
