...
class Snapshot:
	...
	MIN_SCOUT_PRIORITY = 1 * PRIORITY_SIZE
	MAX_SCOUT_PRIORITY = MIN_SCOUT_PRIORITY + PRIORITY_SIZE - 1

	MIN_RECORD_PRIORITY = 2 * PRIORITY_SIZE
	MAX_RECORD_PRIORITY = MIN_RECORD_PRIORITY + PRIORITY_SIZE - 1

	MIN_PUBLISH_PRIORITY = 3 * PRIORITY_SIZE
	MAX_PUBLISH_PRIORITY = MIN_PUBLISH_PRIORITY + PRIORITY_SIZE - 1
